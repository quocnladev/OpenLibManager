...
namespace LibrarySystem
{
    public partial class frmBooks : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Tất cả các trường bắt buộc phải được điền đầy đủ.", "Không hợp lệ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return; 
            }
            ...
            {
                MessageBox.Show("Số ID đã được sử dụng.", "Không hợp lệ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            config.Execute_CUD(sql, "Không thực hiện được truy vấn.", "Sách đã được lưu trong database");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            config.Execute_CUD(sql, "Không thực hiện được truy vấn.", "Sách đã được cập nhật trong database");
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            config.Execute_CUD(sql, "Không thực hiện được truy vấn.", "Sách đã được xóa trong database");
        ...
        private void dtgList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            /*dtgList.Columns["Price"].Visible = false;
            dtgList.Columns["Remark"].Visible = false;*/
        }
